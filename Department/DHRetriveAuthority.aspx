...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Button ID="Button1" runat="server"  class="btn btn-danger" OnClick="Button1_Click" style="z-index: 1; position: absolute; top: 100px; left: 500px; width: 200px; height: 50px;" Text="Retrieve Authority" />
</asp:Content>
